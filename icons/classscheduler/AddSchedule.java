...
public class AddSchedule extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RoomManagement.addSchedule(jLabel3.getText(), jComboBox1.getSelectedItem().toString(), jComboBox3.getSelectedItem().toString(), jComboBox2.getSelectedItem().toString());
            }
        });
